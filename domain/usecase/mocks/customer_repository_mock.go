...
func (m *CustomerRepositoryMock) ExpectDoesNotReturnCustomer(customerId int) *CustomerRepositoryMock {
	m.On("Find", customerId).Return(nil)
	return m
}

func (m *CustomerRepositoryMock) ExpectReturnsInactiveCustomer(customerId int) *CustomerRepositoryMock {
	m.On("Find", customerId).Return(&CustomerStub{customerId, false})
	return m
}

func (m *CustomerRepositoryMock) ExpectReturnsActiveCustomer(customerId int) *CustomerRepositoryMock {
